...
<div class="content-wrapper">
  ...
  <?php echo form_open("nilai_rating/save") ?>
    ...
    <div class="col-8">
      <input id="id" name="id" type="text" value="<?php echo $obj_rating->id?>" class="form-control">
    </div>
  </div>
  <div class="form-group row">
    <label for="nama" class="col-4 col-form-label">Nama</label> 
    <div class="col-8">
      <input id="nama" name="nama" type="text" value="<?php echo $obj_rating->nama?>" class="form-control">
    </div>
  </div>
  <div class="form-group row">
