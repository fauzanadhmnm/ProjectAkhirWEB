...
<div class="content-wrapper">
  ...
  <?php echo form_open("kecamatan/save") ?>
    ...
    <div class="col-8">
      <input id="id" name="id" type="text" value="<?php echo $obj_kecamatan->id?>" class="form-control">
    </div>
  </div>
  <div class="form-group row">
    <label for="nama" class="col-4 col-form-label">Nama</label> 
    <div class="col-8">
      <input id="nama" name="nama" type="text" value="<?php echo $obj_kecamatan->nama?>"class="form-control">
    </div>
  </div>
  <div class="form-group row">
