...
<body>
    ...
    <section class="hero" style="background: linear-gradient(95deg, #5533ff 40%, #25ddf5 100%);">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-8 mx-auto mb-4" style="margin-top: 91px;">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="username" value="" placeholder="Masukan username">
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control" name="email" value="" placeholder="Masukan alamat E-mail">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control" name="password1" value="" placeholder="Masukan password">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control" name="confirm-password" value="" placeholder="Konfirmasi password">
                                </div>
                                <button type="submit" class="btn btn-block my-3" style="background-color: #3ecf8e;">Daftar</button>
                                <?php form_close() ?>
